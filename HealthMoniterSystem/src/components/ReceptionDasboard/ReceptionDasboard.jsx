...
export default function ReceptionDasboard() {
                ...
                <main>
                    <div className="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
                        <div className='flex justify-between max-[840px]:flex-col'>
                            <div>
                                {/* <div className="max-w-xs mt-8 rounded-lg overflow-hidden shadow-lg max-[840px]:items-center max-[840px]:m-auto">
                                    <div className='pt-8 pl-8 pr-8'>
                                        <img className="w-full rounded-full" src={receptionistimg} alt="Sunset in the mountains" />
                                    </div>
                                ...
                                <div className="flex flex-col leading-10 max-w-xl mt-8 rounded-lg overflow-hidden bg-gray-50 shadow-xl border-2 border-gray-100">
                                    <div className='pt-8 pl-8 pr-8'>
                                        <img className="m-auto w-60 rounded-full" src={receptionistimg} alt="Sunset in the mountains" />
                                    </div>
                                ...
                                <div className='flex flex-row justify-center mt-20 max-[500px]:flex-col max-[840px]:items-center max-[840px]:justify-center max-[840px]:ml-0'>
                                    <Link
                                        to={"/appointment"}
                                    ...
                                    ><button
                                        type="submit"
                                    // className="flex justify-center rounded-md bg-indigo-600 px-3 py-2.5 text-sm font-semibold leading-6 text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600 max-[500px]:mb-5 max-[500px]:w-full lg:mr-5"
                                    >
                                            Make Appointment
                                        </button></Link>
                                ...
                                <div className='flex flex-row justify-center mt-4 max-[500px]:flex-col max-[840px]:items-center max-[840px]:justify-center max-[840px]:ml-0'>
                                    <Link
                                ...
                                <div className='w-[44rem] ml-24 max-[400px]:w-auto max-[600px]:w-96 max-[670px]:m-auto max-[711px]:w-[35rem] max-[755px]:w-[40rem] max-[840px]:justify-center max-[840px]:ml-5'>
                                    ...
                                    <div className='mt-5 h-80 overflow-auto max-[500px]:mt-10'>
                                        <ul role="list" className="divide-y divide-gray-100">
                                            {data.filter((item) => appointmentSearchPending ? `${item.firstname} ${item.lastname} ${item.sap}`.toLowerCase().includes(appointmentSearchPending.toLowerCase()) & item.appstatus === 'pending' : item.appstatus === "pending").map((item) => (
